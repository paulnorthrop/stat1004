...
The normal (or Gaussian) distribution (Section 5.7 of the [STAT1004 notes](https://moodle.ucl.ac.uk/mod/resource/view.php?id=2079737)) is a symmetric probability distribution.  If $Y = \ln X$ has a normal distribution then $X$ has a *log-normal* distribution.  This is a convenient example to study because if we know that we have a sample from a log-normal distribution then taking logs of the data produces a sample from a normal distribution.
