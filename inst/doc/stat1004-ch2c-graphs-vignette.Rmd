...
We have a numeric continuous variable, `birth_times`, and a categorical variable, `day`.  The following code produces the graphs in the [STAT0002 lecture slides](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3) that contain a plot of birth_times for each day of the week. 
