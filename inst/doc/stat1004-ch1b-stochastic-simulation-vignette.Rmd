...
One such method is the *generalized ratio-of-uniforms* method (@WGS1991 and references therein), which can be used for univariate distributions (involving one random variable) and for multivariate distributions (involving two or more random variables), provided that the p.d.f. of the distributions satisfies some conditions.  The *rust* R package [@rust] implements this algorithm.  
