...
The main purpose of this vignette is to provide R code to produce graphs that feature in Sections 2.4 and 2.5 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3).  All these graphs involve one variable only.
See also the [Chapter 2: Graphs (more than one variable)](stat1004-ch2b-graphs-2-vignette.html).
...
The following code produces the histogram-like alternative plots in the lecture slides [STAT1004 lecture slides](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3).  As you can see we can do many things to change the appearance of plots. Use `?par` to see a list of the graphical parameters that we can use.
...
The short [How to draw a histogram video](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=9) also describes how to draw a stem-and-leaf plot.
