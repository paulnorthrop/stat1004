...
The basic building block of stochastic simulation methods is the ability to simulate numbers (pseudo-) randomly from the interval (0,1).  As we will see in Section 5.7 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3) this is equivalent to generating numbers that behave approximately like a random sample from a standard uniform U(0,1) distribution.
...
The exponential distribution (see Section 5.6 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3)) is an example of a probability distribution of a continuous random variable (see Section 4.2 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3)).
...
(see Section 2.5 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3)) and superimpose the probability density function (p.d.f.) of the exponential distribution from which these values have been simulated.
...
After you have answered Question 5 of the [Quiz for Exercises 6](https://moodle-1819.ucl.ac.uk/mod/quiz/view.php?id=316126) you will see why the following R code could be used to simulate from an exponential distribution.
...
See the 
[Stochastic simulation video](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=9) for some detail.  The following code implements this for the normal distribution
(see Section 5.7 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3)).
...
Note that the help page calls this the *quantile function*.  An alternative name is the *inverse cumulative distribution function* or *inverse c.d.f* (see Section 5.7 of the [STAT0002 notes](https://moodle-1819.ucl.ac.uk/course/view.php?id=8579&section=3)).
