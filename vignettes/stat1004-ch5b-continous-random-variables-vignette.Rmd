...
The purposes of this vignette are to direct you to R functions relating to the **continuous** probability distributions condsidered in Chapter 5 of the STAT0002 notes and to provide code to do some of the things that appear in the lecture slides.  We do this using the standard R functions (in the **stats** package) and using the **distributions3** package, which provides a neat way to work with random variables in R.  Please see the [Discrete Random Variables vignette](stat1004-ch5a-discrete-random-variables-vignette.html) for a brief introduction to these functions.
