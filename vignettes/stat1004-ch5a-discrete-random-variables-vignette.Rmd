...
The purposes of this vignette are to direct you to R functions relating to the **discrete** probability distributions condsidered in Chapter 5 of the STAT0002 notes and to provide code to do some of the things that appear in the lecture slides.  First, we do this using the standard R functions (in the **stats** package).  Then we repeat some of the calculations using the **distributions3** package, which provides a neat way to work with random variables in R.
