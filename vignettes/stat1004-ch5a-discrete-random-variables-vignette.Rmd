...
The purposes of this vignette are to direct you to R functions relating to the **discrete** probability distributions condsidered in Chapter 5 of the STAT0002 notes and to provide code to do some of the things that appear in the lecture slides.  
...
plot(0:10, pmf(N, 0:10), type = "h", ylab = "P(N = n)", xlab = "n")
