...
For information about R see [STAT0004 Moodle page](https://moodle.ucl.ac.uk/course/view.php?id=8581) (if you are taking STAT1006) or [Introduction to R Moodle page](https://moodle.ucl.ac.uk/course/view.php?id=10773) (if you are not taking STAT1006, e.g. Natural Sciences students).

The R code used in this vignette are available: [shuttle-vignette.R](stat1004-ch1a-shuttle-vignette.R).  The functions `shuttle_sim` and `shuttle_sim_plot` can be viewed either by typing the name of the function at R command prompt `>` or at  [GitHub](https://github.com/paulnorthrop/stat1004/tree/master/R/shuttle_sim.R)

If you have any questions please ask them using the [STAT0002 discussion forum](https://moodle.ucl.ac.uk/mod/hsuforum/view.php?id=755813).

## The Challenger Space Shuttle Disaster

In the first lecture we discussed the Challenger Space Shuttle Disaster.   In this vignette we are concerned mainly with the R code, so there is very little discussion of the problem, the data or statistical ideas.  For discussion of these see the notes and/or lecture slides in the [Notes](https://moodle.ucl.ac.uk/course/view.php?id=8579&section=3) section of the STAT0002 Moodle page.

In this vignette we consider how R can be used to analyse data related to this disaster.  See @shuttle for more information about these data and analyses to estimate the probability of a catastrophic failure of the Challenger space shuttle under the launch conditions on 28th January 1986.  This paper is used as a [worked example](https://moodle.ucl.ac.uk/mod/resource/view.php?id=316154) for the [STAT0002 Meet your Professor ICA](https://moodle.ucl.ac.uk/course/view.php?id=8579&section=4).
