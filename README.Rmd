...
[![Travis-CI Build Status](https://travis-ci.org/paulnorthrop/stat1004.svg?branch=master)](https://travis-ci.org/paulnorthrop/stat1004) 
...
If you would like to use RStudio (a user-friendly front-end to R) then you can get it from 
[here](https://www.rstudio.com/products/rstudio/download/) [See "Installers for Supported Platforms" near the bottom of the page]
